...
#  v = PacketFu::PcapFile.read_packets(pcapd) do |pkt|
  ...
  #puts proto! "Total Packets: ".ljust(20).foreground(:magenta).bright #+ "#{v}".proto.foreground(:magenta).bright
  ...
  puts "IP Packets: ".ljust(20).foreground(:magenta).bright + "#{ip_count}".foreground(:magenta).bright
  ...
  # TCP details to user
  puts "Total connections:".ljust(20).foreground(:magenta).bright + "#{tcp_count}".rjust(25).foreground(:magenta).bright
  puts "TCP closed:".ljust(20).foreground(:magenta).bright + "#{tcp_count}".rjust(25).foreground(:magenta).bright
  puts "TCP open:".ljust(20).foreground(:magenta).bright + "#{tcp_count}".rjust(25).foreground(:magenta).bright
  puts "TCP filtered:".ljust(20).foreground(:magenta).bright + "#{tcp_count}".rjust(25).foreground(:magenta).bright
